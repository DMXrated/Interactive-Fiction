...
<body>
<div id="player_inventory"><span
	class="item-container"><h3>Inventory:</h3>
...
<div id="impress">
	...
	<div id="slide2" class="step slide" data-x="1500">
		...
		<div class="inventory-box"><img src="dino.png" alt="dino" class="item" id="dino"></div></div>
	</div>
	...
	<div class="menu"><a href="#slide1">START OVER</a></div>
</div>
